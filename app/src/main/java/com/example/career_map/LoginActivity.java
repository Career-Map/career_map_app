...
import com.example.career_map.databinding.ActivityLoginBinding;
import com.example.career_map.databinding.AlertlayoutBinding;
            ...
            firebaseAuth.signInWithEmailAndPassword(
                ...
                public void onSuccess(AuthResult authResult) {
                    ...
                    if (firebaseAuth.getCurrentUser().isEmailVerified()) {
                        ...
                        Snackbar snackbar = Snackbar.make(activityLoginBinding.LoginLayout, "Please verify your account.", Snackbar.LENGTH_LONG).setAction("Verify", new View.OnClickListener() {
                            @Override
